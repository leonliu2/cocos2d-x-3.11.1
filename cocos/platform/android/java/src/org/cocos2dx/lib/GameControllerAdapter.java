...
public class GameControllerAdapter {
	...
	private static final String TAG = GameControllerAdapter.class.getSimpleName();
    ...
    public static void onButtonEvent(final String vendorName, final int controller, final int button, final boolean isPressed, final float value, final boolean isAnalog)
    {
    	...
    	Log.d(TAG,"===GameControllerAdapter onButtonEvent vendorName:" + vendorName + " controller:" + controller + " button:" + button);
    ...
    {
    	Log.d(TAG,"===GameControllerAdapter onAxisEvent vendorName:" + vendorName + " controller:" + controller + " button:" + axisID + " value:" + value + " isAnalog:" + isAnalog );
