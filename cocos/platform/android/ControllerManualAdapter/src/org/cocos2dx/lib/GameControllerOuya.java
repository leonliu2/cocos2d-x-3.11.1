...
public class GameControllerOuya implements GameControllerDelegate{
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent event) {
        ...
        Log.d("debug", "===  GameControllerOuya::dispatchGenericMotionEvent event:" + event );
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        Log.d("debug", "===  GameControllerOuya dispatchKeyEvent action:" + action + " keyCode:" + keyCode);
        
        
        
        if (action == KeyEvent.ACTION_DOWN) {
        	Log.d("debug", "===  GameControllerOuya 按下 keyCode:" + keyCode );
            handled = OuyaController.onKeyDown(keyCode, event);
        }
        else if (action == KeyEvent.ACTION_UP) {
        	Log.d("debug", "===  GameControllerOuya 放開 keyCode:" + keyCode );
