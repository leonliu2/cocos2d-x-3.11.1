...
public class GameControllerMoga implements ControllerListener, GameControllerDelegate {
    ...
    public void onKeyEvent(KeyEvent event) {   
    	...
    	Log.d("debug", "===  GameControllerMoga::onKeyEvent  event:" + event );
    ...
    public void onMotionEvent(MotionEvent event) {
    	...
    	Log.d("debug", "===  GameControllerMoga::onMotionEvent  event:" + event );
    ...
    public void onStateEvent(StateEvent event) {
    	...
    	Log.d("debug", "===  GameControllerMoga::onStateEvent  event:" + event );
